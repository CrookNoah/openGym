...
import { MACROS, MACRO_NAME, SOURCES, addFood, updateFood, removeFood, normalizeEntry, kcalFromMacros, targetOf, suggestProtein } from './lib/food.js'
import { searchFood, scaleProduct } from './lib/foodsearch.js'
...
/* ============================ how to add ============================ */
export const addFoodSheet = iso => ui().openSheet(close => <>
  <h3>{t('Add food')}</h3>
  <div className="list">
