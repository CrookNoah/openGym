...
<br>
![GitHub last commit](https://img.shields.io/github/last-commit/CrookNoah/openGym?style=flat-square)
[![GitHub stars](https://img.shields.io/github/stars/CrookNoah/openGym?style=flat-square)](https://github.com/CrookNoah/openGym/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/CrookNoah/openGym?style=flat-square)](https://github.com/CrookNoah/openGym/issues)
...
admin dashboard only exist in a self-hosted instance. The site and demo above are
upstream's — they run the original app, without this fork's additions.</sub>
...
- 🎯 **A goal that's actually tracked** — set one and openGym measures it against the *trend* in your weigh-ins rather than any one morning, refuses to judge before there's enough data, and when you stall checks whether you were following the plan before it ever suggests eating less
- 💬 **A coach you can ask** — reads your real plan, sessions and weight trend and answers questions about them, plus a written weekly review. It can't invent your numbers and it can't change anything without you pressing a button. Runs on your own Anthropic key; everything else works identically without it
- 🍽️ **Meals, not just calories** — the daily target splits across breakfast, lunch, snacks and dinner by an eating style (Balanced, Vertical diet, Mediterranean, High protein, 16:8), each meal priced with a plate suggestion, mealtime reminders that ask what you ate, and a standing "worth buying" card for the kit your goal is missing
- 👋 **Two-minute setup** — a first-run walkthrough chains your weight and goal, your equipment, a generated week and diet targets computed from all of it, then tells you what kit is worth buying for your goal and why
- 🛋️ **Notifications that escalate** — on the Android build, planned-workout days start nagging at the time you usually get home and get one rung sharper every hour until you train. Three tones (the sweariest is opt-in), a quiet hour, a "Not home" button on every notification, and it remembers the weekday you keep ducking
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders ([download from this fork’s releases](https://github.com/CrookNoah/openGym/releases))
...
```bash
git clone https://github.com/CrookNoah/openGym
cd openGym
cp .env.example .env
...
- **Android:** [**download the APK**](https://github.com/CrookNoah/openGym/releases) and sideload it —
...
- [x] Standalone mobile app — Android APK to sideload ([download from this fork’s releases](https://github.com/CrookNoah/openGym/releases)); on iOS as a self-hosted PWA (no store listings planned)
